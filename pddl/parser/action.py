...
"""Implementation of the PDDL action parser."""
...
from pddl.parser import ACTION_GRAMMAR_FILE, PARSERS_DIRECTORY
...
class ActionTransformer(Transformer[Any, Domain]):
    """Action Transformer."""
...
_action_parser_lark = ACTION_GRAMMAR_FILE.read_text()
...
class ActionParser:
    ...
    def __init__(self):
        """Initialize."""
        self._transformer = ActionTransformer()
        self._parser = Lark(
            _action_parser_lark, parser="lalr", import_paths=[PARSERS_DIRECTORY]
        )
